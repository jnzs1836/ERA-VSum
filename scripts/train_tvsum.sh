...
python train_avs.py \
  ...
  --n_epochs 50 \
  --split_path  /your/split/file/path/tvsum_splits.json \
  --dataset_dir  /your/dataset/dir \
  --dataset_name eccv16_dataset_tvsum_google_pool5 \
  ...
  --with_images True \
  --video_dir /your/video/dir/path/TVSum/videos \
  --mapping_file /your/mappings/file/path/tvsum_mapping.json \
  --stgcn_shortcut 1 \
  --variance_loss ssum \
  --sparsity_loss slen \
  --split_ids 0